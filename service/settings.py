...
SECRET_KEY = 'django-insecure-cms72cgl+01^x^&hr#v616(xyzs99fgvl&g5ta^-u)rxww5$4f'
...
if os.environ.get("DATABASE_URL", None):
    DATABASES = {
        #dj_database_url он нужен чтобы распарсить DATABASE_URL
...
CELERY_BROKER_URL = os.environ.get("CLOUDAMQP_URL", 'redis://redis:6379/0' )
